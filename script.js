...
const songs = [
    ...
    {
        title: "Her",
        description: "You'll be my FAV GIRL 💫",
        emoji: "💕",
        url: "her.mp3" 
    },
    {
...
function nextPage(pageNum) {
    ...
    window.scrollTo(0, 0);
      ...
      // Hide continue button when leaving page 5
    if (pageNum === 6) {
...
function closeCardsModal() {
    ...
    // Show the continue button after closing the modal
...
function completeBirthday() {
    ...
    const sealingAnim = document.getElementById('sealingAnimation');
    sealingAnim.classList.add('active');
    
    // After animation completes (4 seconds), show the completion modal
    setTimeout(() => {
        sealingAnim.classList.remove('active');
        document.getElementById('completionModal').classList.add('active');
    }, 4000);
}
